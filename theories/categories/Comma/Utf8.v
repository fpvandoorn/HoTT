...
(*Set Printing All.
Check (λ(C : PreCategory)(D : PreCategory)(E : PreCategory)(S : Functor C D) (T : Functor E D), (S ↓ T)%category).
Check (λ(D : PreCategory)(E : PreCategory)(S : Functor E D) (x : D), (x ↓ S)%category).
Check (λ(D : PreCategory)(E : PreCategory)(S : Functor E D) (x : D), (S ↓ x)%category).*)
