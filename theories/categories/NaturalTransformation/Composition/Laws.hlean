...
section associativity
  ...
  section functors
    ...
    definition associator_1 : NaturalTransformation F0 F1 :=
         Eval simpl in
          generalized_identity F0 F1 refl idpath.

    definition associator_2 : NaturalTransformation F1 F0 :=
         Eval simpl in
          generalized_identity F1 F0 refl idpath.
  End functors.
...
section functor_identity
  ...
  section left
    ...
    : NaturalTransformation (1 ∘ F) F :=
         Eval simpl in generalized_identity (1 ∘ F) F refl idpath.
    definition left_identity_natural_transformation_2
    : NaturalTransformation F (1 ∘ F) :=
         Eval simpl in generalized_identity F (1 ∘ F) refl idpath.
  ...
  section right
    ...
    definition right_identity_natural_transformation_2 : NaturalTransformation F (F ∘ 1) :=
         Eval simpl in generalized_identity F (F ∘ 1) refl idpath.
