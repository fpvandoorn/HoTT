...
section identity_lemmas
  ...
  /- left identity : [1 ∘ F = F] -/
  /- If we had that [match (p : a = b) in (_ = y) return (a = y) with refl => refl end ≡ p] (a form of eta for paths), this would be judgemental. -/
...
section composition_lemmas
  ...
  : ap object_of (associativity F G H) = refl :=
