...
Proof.
  ...
  transitivity ((p x)⁻¹ ⬝ p x). apply symmetry. apply concat_Vp.
  apply whiskerR.  apply symmetry. apply concat_p1.
Qed.
...
/-begin
  ...
  apply ap.  apply symmetry.  apply (ap_compose f g q).
...
/-begin
  destruct q.
  apply symmetry. apply concat_Vp.
end-/
-/
